...
### [1. 关键渲染路径](./critical-rendering-path.md)
- 浏览器从 URL 到像素的完整流程
...
### [3. 运行时性能](./runtime-performance.md)
...
### [4. Core Web Vitals](./core-web-vitals.md)
...
### [5. 动画性能](./animation-performance.md)
...
### [6. 感知性能](./perceived-performance.md)
- "真的快" vs "感觉快"
...
### [7. 性能预算与监控](./performance-budget-monitoring.md)
